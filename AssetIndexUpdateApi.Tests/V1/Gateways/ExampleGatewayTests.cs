using AutoFixture;
using AssetIndexUpdateApi.Tests.V1.Helper;
using AssetIndexUpdateApi.V1.Domain;
using AssetIndexUpdateApi.V1.Gateways;
using FluentAssertions;
using NUnit.Framework;

namespace AssetIndexUpdateApi.Tests.V1.Gateways
{
    //TODO: Remove this file if Postgres gateway is not being used
    //TODO: Rename Tests to match gateway name
    //For instruction on how to run tests please see the wiki: https://github.com/LBHackney-IT/lbh-asset-index-update-api/wiki/Running-the-test-suite.
    [TestFixture]
