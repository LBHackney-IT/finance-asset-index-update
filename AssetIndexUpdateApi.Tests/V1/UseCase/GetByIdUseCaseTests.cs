...
namespace AssetIndexUpdateApi.Tests.V1.UseCase
{
    public class GetByIdUseCaseTests : LogCallAspectFixture
    {
        ...
        //Guidance on unit testing and example of mocking can be found here https://github.com/LBHackney-IT/lbh-asset-index-update-api/wiki/Writing-Unit-Tests
    }
}
