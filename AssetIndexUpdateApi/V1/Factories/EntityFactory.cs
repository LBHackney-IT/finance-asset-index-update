...
namespace AssetIndexUpdateApi.V1.Factories
{
    public static class EntityFactory
    {
        public static Entity ToDomain(this DatabaseEntity databaseEntity)
        {
            ...
            // More information on this can be found here https://github.com/LBHackney-IT/lbh-asset-index-update-api/wiki/Factory-object-mappings
